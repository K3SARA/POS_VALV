  ...
  return (
    <div className="admin-shell">
      <style>{`
        ...
        .stock-table-wrap { max-height: 440px; overflow-y: auto; overflow-x: auto; border: 1px solid var(--border); border-radius: 10px; }
        .stock-table-wrap table { width: 100%; border-collapse: collapse; }
        .stock-table-wrap thead th { position: sticky; top: 0; z-index: 2; }
        .stock-table-wrap tbody td { height: 44px; box-sizing: border-box; }
